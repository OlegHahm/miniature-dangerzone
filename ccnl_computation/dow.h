 ...
 * @{
 */
#define DOW_EVENT_PERIOD        (DOW_D * US_PER_SEC)
//#define DOW_EVENT_PERIOD_JITTER (DOW_D * US_PER_SEC) + (random_uint32() & 0x000FFFFF)

#define DOW_EVENT_PERIOD_JITTER (US_PER_SEC) + (random_uint32() & 0x1FFFFFF)
...
#define DOW_KEEP_ALIVE_PERIOD   (100 * US_PER_MS)

//#define DOW_STARTUP_DELAY       (DOW_D * (random_uint32() & 0x000001FF) * US_PER_MS)
...
#define DOW_BEACONING_WAIT      ((DOW_BEACONING_COUNT + 1) * US_PER_SEC)
/** @} */
